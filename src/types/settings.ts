...
export interface ResourceSite {
    ...
    name: string         // 显示名称
    fetchMode: 'http' | 'webview' | 'both'  // 获取模式
...
export const defaultSettings: AppSettings = {
    ...
    scrape: {
        concurrent: 5,
        scraperPriority: ['javbus', 'javdb'],
        webviewEnabled: false,
        defaultSite: 'javbus',
        sites: [
            { id: 'javbus', name: 'JavBus', fetchMode: 'http', enabled: true },
            { id: 'javmenu', name: 'JavMenu', fetchMode: 'http', enabled: true },
            { id: 'javplace', name: 'JavPlace', fetchMode: 'http', enabled: true },
            { id: 'projectjav', name: 'ProjectJAV', fetchMode: 'http', enabled: true },
            { id: 'threexplanet', name: '3xPlanet', fetchMode: 'http', enabled: true },
            { id: 'freejavbt', name: 'FreeJavBT', fetchMode: 'http', enabled: true },
